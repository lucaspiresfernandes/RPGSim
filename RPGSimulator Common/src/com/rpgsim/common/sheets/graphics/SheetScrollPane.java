...
*
*/
public class SheetScrollPane extends JScrollPane
{
    ...
    public SheetScrollPane(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public SheetScrollPane(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(SheetScrollPane sp) {
            this.sp = sp;
        }
